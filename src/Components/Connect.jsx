  ...
  return (
    <section className="section-third" id="section-third">
      <div className="header">
        <h3 className="hidden show work-title">CONNECT</h3>
        <p className="hidden show">
          Explore more of my things and projects below
        </p>
        <section className="contacts-container">
          <a
            href="https://www.behance.net/juliabohlin"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className="contact-card hidden show" id="behance-link">
              <svg
          ...
          <a
            href="https://github.com/bohlini"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className="contact-card hidden show" id="github-link">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
          ...
          <a
            href="mailto:julia.bohlin@hyperisland.se"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className="contact-card hidden show" id="gmail-link">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
